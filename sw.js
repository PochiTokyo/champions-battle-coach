const CACHE='cbc-v041';
const ASSETS=['./','./index.html','./style.css','./data.js','./selection.js','./battle.js','./team-scout.js','./history-ocr.js','./vision-scan.js','./vision-local.js','./init.js','./manifest.webmanifest','./icon.svg'];
