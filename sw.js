const CACHE='cbc-v032';
const ASSETS=['./','./index.html','./style.css','./data.js','./selection.js','./battle.js','./team-scout.js','./history-ocr.js','./init.js','./manifest.webmanifest','./icon.svg'];
