const CACHE='cbc-v042';
const ASSETS=['./','./index.html','./style.css?v=042','./data.js?v=042','./selection.js?v=042','./battle.js?v=042','./team-scout.js?v=042','./history-ocr.js?v=042','./vision-scan.js?v=042','./vision-local.js?v=042','./init.js?v=042','./manifest.webmanifest?v=042','./icon.svg'];
